...
proba_df = pd.DataFrame(
    {"true_label": y_test, "predicted_label": y_pred, "probability_toxic": y_proba}
)
...
report = classification_report(
    y_test, y_pred, target_names=["Non-Toxic", "Toxic"], output_dict=True
)
...
joblib.dump(model, "models/toxic_baseline_classifier.pkl")
